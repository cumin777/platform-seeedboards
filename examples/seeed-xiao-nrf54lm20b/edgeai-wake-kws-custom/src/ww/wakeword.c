...
#include "../dmic.h"
#ifndef WW_MODEL_HEADER
#error "WW_MODEL_HEADER must be set by zephyr/CMakeLists.txt"
#endif
#include WW_MODEL_HEADER
#include "wakeword.h"
...
int ww_init(void)
{
	/* Solution 95647 ("hello seeed") generated by Nordic Edge AI Lab. */
	ww_model = nrf_edgeai_user_model_95647();
