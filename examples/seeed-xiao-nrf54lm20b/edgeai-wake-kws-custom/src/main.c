...
int main(void)
{
	...
	LOG_INF("=== XIAO nRF54LM20B: custom wakeword + KWS (Axon NPU) ===");
	LOG_INF("Listening on the onboard PDM microphone; no Bluetooth is used.");
	LOG_INF("Wake word: hello seeed (solution 95647).");
	LOG_INF("Keywords: no, ok, opus, stop, yes (solution 95649).");
